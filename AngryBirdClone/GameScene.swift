...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    //enum: kategoriler oluşturuyoruz
    //genelde collider type denir
    enum ColliderType: UInt32{
        case Bird = 1
        case Box = 2
        //2'den fazla objemiz olsaydı 3.objemize 3 diyemezdik
        //çünkü ilk objemizin toplamına eşit olmamalı
        //hep son case'imizi 2 ile çarpmalı ve elde ettiğimiz sonucu bi sonraki caseimize atamalıyız
 ...
 */
        ...
        self.physicsWorld.contactDelegate = self //artık contactları algılama opsiyonumuz var
...
*/
    ...
    //contact olma durumunu yazıyoruz
